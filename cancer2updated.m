...
% %% Crop The Breast
% The image was binarized with a threshold value of 0.1
z=im2bw(i,0.1);   
figure(2)
...
% % Edge detection (only mentioned to compare the result, this does not apply with Weiner & CLAHE filter)
% % Given a grayscale image or an intermediate matrix, the Sobel operator performs a 2-D spatial 
% %gradient measurement on an image and so emphasizes regions 
